 ...
 */
foodtruck.views.SearchBar = Ext.extend(Ext.Panel, {
    ...
    initComponent: function() {
        ...
        foodtruck.views.SearchBar.superclass.initComponent.apply(this, arguments);
    }
});

Ext.reg('searchBar', foodtruck.views.SearchBar);